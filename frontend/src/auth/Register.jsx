            ...
            <div className='bg-[#F1F0F0] flex flex-col p-6 rounded-2xl text-center min-h-110 min-w-96 relative drop-shadow-2xl'>
                ...
                <div className=' p-1 rounded-sm h-auto '>
                    ...
                    <div className='w-full   mt-6'>
                        <button className='bg-blue-800 text-white w-full pt-2 pb-2 rounded-xl'>register</button>
                    </div>
                </div>
                ...
                <div className='text-right text-zinc-500 text-[15px] mt-4'>
                    <a className='' href="#">Already registered ? <span className='text-blue-800 hover:underline'>login here</span></a>
                </div>
