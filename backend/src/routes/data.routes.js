...
import { addData, deleteApplication, readAll, statusProvider, updateApplication } from "../controllers/data.controller.js";
...
dataRouter.route("/get-status").get(authenticate, statusProvider)
